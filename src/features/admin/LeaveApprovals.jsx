...
export function LeaveApprovals({ employees, leaves, adminRegs, decideLeave, decideRegularization, onAudit }) {
  ...
  return (
    <>
      ...
      <Card>
        <h3 className="text-white font-semibold mb-3">Pending Requests <span className="ml-2 bg-orange-500/20 text-orange-300 text-xs px-2 py-0.5 rounded-full border border-orange-500/30">{pendingLeaves.length}</span></h3>
