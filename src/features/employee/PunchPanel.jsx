...
export function PunchPanel({ currentUser, record, stdHours, holidays, punch, locationStatus, locationBlocked, autoTrackingActive, odTrackingActive, odTrackLog }) {
  ...
  return (
    <>
      <Card>
        ...
        {autoTrackingActive && (
          <div className="mt-2 p-2 bg-emerald-500/8 border border-emerald-500/15 rounded-xl flex items-center gap-2">
